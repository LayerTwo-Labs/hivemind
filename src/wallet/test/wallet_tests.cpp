...
BOOST_FIXTURE_TEST_CASE(rescan, hivemind100Setup)
{
    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see hivemindd log for details) and could be dealt with by "
...
BOOST_FIXTURE_TEST_CASE(importwallet_rescan, hivemind100Setup)
{
    // TODO Make this test work without block subsidy
    /*
...
// debit functions.
BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit, hivemind100Setup)
{
    // TODO Make this test work without block subsidy
    /*
    CWallet wallet;
...
/*
class ListCoinsTestingSetup : public hivemind100Setup
{
public:

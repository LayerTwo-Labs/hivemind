...
const char * const BITCOIN_CONF_FILENAME = "hivemind.conf";
const char * const BITCOIN_PID_FILENAME = "hivemindd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/hivemind";
#else
    // Unix

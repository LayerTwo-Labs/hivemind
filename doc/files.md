...
* bitcoin.conf: contains configuration settings for hivemindd or bitcoin-qt
* hivemindd.pid: stores the process id of hivemindd while running
...
* debug.log: contains debug information and general logging generated by hivemindd or bitcoin-qt

...
- #8829 `2a8bca4` Add hivemind-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_hivemindds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update hivemind-tx to output witness data (jnewbery)

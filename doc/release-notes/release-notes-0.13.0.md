...
hivemind-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/hivemind-cli -stdin walletpassphrase
    mysecretcode
    120
...
- #7550 `8b958ab` Input-from-stdin mode for hivemind-cli (laanwj)
...
- #8257 `ff03c50` Do not ask a UI question from hivemindd (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for hivemindd procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of hivemindd startup (laanwj)

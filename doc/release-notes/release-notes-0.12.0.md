...
This allows running hivemindd without having to do any manual configuration.
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass hivemindd rpc basic auth
...
Restarting hivemindd will no longer clear out the list of banned peers; instead
...
- #6600 `ef4945f` Include hivemind-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix hivemind-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of hivemind-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [hivemind-cli] improve error output (Jonas Schnelli)

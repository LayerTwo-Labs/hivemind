...
- #5809 `46bfbe7` Add hivemind-cli man page
...
- #5849 `41259ca` contrib/init/hivemindd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for hivemind-tx)
